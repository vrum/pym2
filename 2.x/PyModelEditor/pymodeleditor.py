...
class PyModelEditor(object):
	...
	def editTransparency(self):
		...
		self.tChooser.setModel(self.m2)
		self.tChooser.show()
	...
	def editRenderflags(self):
		...
		self.rfChooser.setModel(self.m2)
		self.rfChooser.show()
	...
	def editTextures(self):
		...
		self.texChooser.setModel(self.m2)
	...
	def editUVAnimations(self):
		...
		self.uvEditor.setModel(self.m2)
		self.uvEditor.show()
	...
	def showBoneTree(self):
		...
		self.bonetree.setModel(self.m2)
		self.bonetree.show()
